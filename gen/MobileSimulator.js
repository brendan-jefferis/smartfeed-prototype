...
Elm.Component.SmartFeedTile.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("smart-feed-tile")]),
      _U.list([$Html.text("tile")]));
   });
...
Elm.Component.SmartFeed.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var tileList = function (tile) {
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("tile")]),
      _U.list([$Html.text(tile.title)]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      ...
      A2($List.map,tileList,model.tiles))]));
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      return model;
   ...
   var NoOp = {ctor: "NoOp"};
   var actions = $Signal.mailbox(NoOp);
   var Model = function (a) {    return {tiles: a};};
   var dummyTiles = _U.list([{title: "Tile 1"
                             ,logoUrl: "/images/logos/logo1.jpg"
                             ,caption: "This is the first tile"
                             ,photoUrl: "/images/tiles/1.jpg"
                             ,isFavourite: false
                             ,url: "/tiles/1"}
                            ,{title: "Tile 2"
                             ,logoUrl: "/images/logos/logo2.jpg"
                             ,caption: "This is the second tile"
                             ,photoUrl: "/images/tiles/2.jpg"
                             ,isFavourite: false
                             ,url: "/tiles/2"}]);
   ...
   var dummyProductsTwo = _U.list([{title: "Product 4"
                                  ...
                                  ,{title: "Product 6"
                                   ...
                                   ,isFavourite: false
                                   ,isInCart: false
                                   ,photoUrl: "/images/product/6.jpg"
                                   ,url: "/products/6"}]);
   var dummyProductsOne = _U.list([{title: "Product 1"
                                   ,description: "This is the first product"
                                   ,price: 12.99
                                   ,isFavourite: false
                                   ,isInCart: false
                                   ,photoUrl: "/images/product/1.jpg"
                                   ,url: "/products/1"}
                                  ,{title: "Product 2"
...
Elm.Component.MobileSimulator.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.h4,
              ...
              _U.list([A2($Component$SmartFeed.view,
