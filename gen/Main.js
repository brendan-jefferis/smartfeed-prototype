...
Elm.Common.Alias.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var emptyMaterials = _U.list([{name: ""
                                 ,modifier: $Maybe.Nothing}]);
   var MaterialSelector = F2(function (a,b) {
      return {name: a,modifiers: b};
   });
   var Material = F2(function (a,b) {
      return {name: a,modifier: b};
   });
   var Product = F9(function (a,b,c,d,e,f,g,h,i) {
      return {title: a
             ,description: b
             ,price: c
             ,isFavourite: d
   ...
   var emptyFilter = {colour: emptyPalette
                     ,material: _U.list([])
                     ,category: _U.list([])
                     ,style: _U.list([])};
   var Filter = F4(function (a,b,c,d) {
      return {colour: a,material: b,category: c,style: d};
   });
...
Elm.Common = Elm.Common || {};
Elm.Common.CheckRow = Elm.Common.CheckRow || {};
Elm.Common.CheckRow.make = function (_elm) {
   "use strict";
   _elm.Common = _elm.Common || {};
   _elm.Common.CheckRow = _elm.Common.CheckRow || {};
   if (_elm.Common.CheckRow.values)
   return _elm.Common.CheckRow.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = F2(function (label,checked) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("check-row clickable")]),
      _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(label)]))
              ,A2($Html.i,
              _U.list([$Html$Attributes.$class(checked ? "fa fa-check-square-o" : "fa fa-square-o")]),
              _U.list([]))]));
   });
   return _elm.Common.CheckRow.values = {_op: _op,view: view};
};
Elm.Common = Elm.Common || {};
Elm.Common.Tag = Elm.Common.Tag || {};
Elm.Common.Tag.make = function (_elm) {
   "use strict";
   _elm.Common = _elm.Common || {};
   _elm.Common.Tag = _elm.Common.Tag || {};
   if (_elm.Common.Tag.values) return _elm.Common.Tag.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var viewWithSwatch = F2(function (hex,label) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("tag with-swatch")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("tag-swatch")
                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "background"
                                                       ,_1: hex}]))]),
              _U.list([]))
              ,A2($Html.span,_U.list([]),_U.list([$Html.text(label)]))
              ,A2($Html.i,
              _U.list([$Html$Attributes.$class("close fa fa-times-circle")]),
              _U.list([]))]));
   });
   ...
   return _elm.Common.Tag.values = {_op: _op
                                   ,view: view
...
Elm.Component.ActiveFilterPanel.make = function (_elm) {
   ...
   _elm.Component.ActiveFilterPanel = _elm.Component.ActiveFilterPanel || {};
   if (_elm.Component.ActiveFilterPanel.values)
   return _elm.Component.ActiveFilterPanel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var isFiltered = function (filter) {
   ...
   var activeFilterText = function (filter) {
      ...
      " & more") : A2($String.join,", ",filters);
      return filterTest;
   };
   var statusIndicatorText = function (filter) {
      return isFiltered(filter) ? A2($Basics._op["++"],
      "Filtering by ",
      activeFilterText(filter)) : "Showing all products";
   };
   var searchBar = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("search-bar")]),
      _U.list([A2($Html.input,
              _U.list([$Html$Attributes.type$("text")
                      ,$Html$Attributes.placeholder("Search for products, colours, styles etc")]),
              _U.list([]))
              ,A2($Html.i,
   ...
   var colourFilterListItem = F2(function (address,colour) {
      return A2($Html.li,
      _U.list([A2($Html$Events.onClick,
      address,
      RemoveColourFilter(colour))]),
      _U.list([A2($Common$Tag.viewWithSwatch,
      colour.hex,
      colour.name)]));
   });
   var colourFilterGroup = F2(function (address,filter) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h4,
              _U.list([$Html$Attributes.$class("subheader")]),
              ...
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("blank")]),
              A2($List.map,colourFilterListItem(address),filter))]));
   });
   var HideFilterPanel = {ctor: "HideFilterPanel"};
   var ShowFilterPanel = {ctor: "ShowFilterPanel"};
   var view = F2(function (address,model) {
      var styleCount = $List.length(model.filter.style);
      var productCount = $List.length(model.filter.category);
      var materialCount = $List.length(model.filter.material);
      var colourCount = $List.length(model.filter.colour.colours);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("active-filter")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("active-filter-bar")]),
      _U.list([A2($Html.span,
              ...
              _U.list([$Html$Attributes.$class("filter-panel")]),
              _U.list([A2($Html.h4,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Keyword")]))
                      ,A2(searchBar,address,model)
                      ,_U.cmp(colourCount,0) > 0 ? A2(colourFilterGroup,
                      address,
...
Elm.Component = Elm.Component || {};
Elm.Component.CategoryFilter = Elm.Component.CategoryFilter || {};
Elm.Component.CategoryFilter.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.CategoryFilter = _elm.Component.CategoryFilter || {};
   if (_elm.Component.CategoryFilter.values)
   return _elm.Component.CategoryFilter.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      switch (_p0.ctor)
      {case "NoOp": return model;
         case "SelectCategory": var _p1 = _p0._0;
           var updatedCategories = A2($List.member,
           _p1,
           model.selectedCategories) ? model.selectedCategories : A2($List._op["::"],
           _p1,
           model.selectedCategories);
           return _U.update(model,{selectedCategories: updatedCategories});
         case "DeselectCategory": return _U.update(model,
           {selectedCategories: A2($List.filter,
           function (c) {
              return !_U.eq(c,_p0._0);
           },
           model.selectedCategories)});
         default: return _U.update(model,
           {selectedCategories: _U.list([])});}
   });
   var Clear = {ctor: "Clear"};
   var DeselectCategory = function (a) {
      return {ctor: "DeselectCategory",_0: a};
   };
   var SelectCategory = function (a) {
      return {ctor: "SelectCategory",_0: a};
   };
   var listItem = F3(function (address,
   selectedCategories,
   category) {
      var checked = A2($List.member,category,selectedCategories);
      var clickAction = checked ? DeselectCategory : SelectCategory;
      return A2($Html.li,
      _U.list([A2($Html$Events.onClick,
      address,
      clickAction(category))]),
      _U.list([A2($Common$CheckRow.view,category,checked)]));
   });
   var view = F2(function (address,model) {
      var featuredCategoriesCount = $List.length(model.featuredCategories);
      var selectedCategoriesCount = $List.length(model.selectedCategories);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("filter-panel product-filter")]),
      _U.list([_U.cmp(selectedCategoriesCount,0) > 0 ? A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Your current products")]))
                      ,A2($Html.ul,
                      _U.list([$Html$Attributes.$class("blank products")]),
                      A2($List.map,
                      A2(listItem,address,model.selectedCategories),
                      model.selectedCategories))
                      ,A2($Html.button,
              ...
              _U.list([]),
              _U.list([]))
              ,_U.cmp(featuredCategoriesCount,0) > 0 ? A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Categories of these products")]))
                      ,A2($Html.ul,
                      _U.list([$Html$Attributes.$class("blank")]),
                      A2($List.map,
                      A2(listItem,address,model.selectedCategories),
                      ...
                      _U.list([$Html.text("Other categories")]))])) : A2($Html.div,
              _U.list([]),
              _U.list([]))
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("blank")]),
              A2($List.map,
              A2(listItem,address,model.selectedCategories),
              model.otherCategories))]));
   });
   var NoOp = {ctor: "NoOp"};
   var Model = F4(function (a,b,c,d) {
      return {featuredCategories: a
             ,selectedCategories: b
             ,otherCategories: c
             ,filteringComplete: d};
   });
   var dummyCategories = _U.list(["Tables","Chairs","Rugs","Art"]);
   var init = F2(function (selectedCategories,featuredCategories) {
      return {featuredCategories: featuredCategories
             ,selectedCategories: selectedCategories
             ,otherCategories: dummyCategories
             ,filteringComplete: false};
   });
   return _elm.Component.CategoryFilter.values = {_op: _op
                                                 ,init: init
                                                 ,update: update
                                                 ,view: view
                                                 ,Model: Model};
...
Elm.Component.ColourFilter.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         ...
         case "ClearSelectedPalette": return _U.update(model,
           {selectedPalette: $Common$Alias.emptyPalette});
         default: return _U.update(model,
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([_U.cmp(selectedPaletteCellCount,0) > 0 ? A2($Html.div,
              ...
              _U.list([A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Colours found in these products")]))
                      ,A2($Html.ul,
                      _U.list([$Html$Attributes.$class("blank colour-palette")]),
                      A2($List.map,
                      A3(colourCell,
...
Elm.Component.MaterialFilter.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      switch (_p0.ctor)
      {case "NoOp": return model;
         case "SelectMaterial": var _p1 = _p0._0;
           var updatedMaterials = A2($List.member,
           _p1,
           model.selectedMaterials) ? model.selectedMaterials : A2($List._op["::"],
           _p1,
           model.selectedMaterials);
           return _U.update(model,{selectedMaterials: updatedMaterials});
         case "DeselectMaterial": return _U.update(model,
           {selectedMaterials: A2($List.filter,
           function (c) {
              return !_U.eq(c,_p0._0);
           },
           model.selectedMaterials)});
         default: return _U.update(model,
           {selectedMaterials: _U.list([])});}
   });
   var Clear = {ctor: "Clear"};
   var DeselectMaterial = function (a) {
      return {ctor: "DeselectMaterial",_0: a};
   };
   var SelectMaterial = function (a) {
      return {ctor: "SelectMaterial",_0: a};
   };
   var listItem = F3(function (address,
   selectedMaterials,
   material) {
   ...
   var view = F2(function (address,model) {
      ...
      var selectedMaterialsCount = $List.length(model.selectedMaterials);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("filter-panel material-filter")]),
      _U.list([_U.cmp(selectedMaterialsCount,0) > 0 ? A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Your current materials")]))
                      ,A2($Html.ul,
                      _U.list([$Html$Attributes.$class("blank materials")]),
                      A2($List.map,
                      A2(listItem,address,model.selectedMaterials),
                      model.selectedMaterials))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn-small secondary")
                              ,A2($Html$Events.onClick,address,Clear)]),
              ...
              _U.list([]),
              _U.list([]))
              ,_U.cmp(featuredMaterialsCount,0) > 0 ? A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Materials found in these products")]))
                      ,A2($Html.ul,
                      _U.list([$Html$Attributes.$class("blank materials")]),
                      A2($List.map,
                      A2(listItem,address,model.selectedMaterials),
                      model.featuredMaterials))
                      ,A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader with-divider")]),
                      _U.list([$Html.text("Other materials")]))])) : A2($Html.div,
              _U.list([]),
              _U.list([]))
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("blank")]),
...
Elm.Component.SmartFeedTile.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.SmartFeedTile = _elm.Component.SmartFeedTile || {};
   if (_elm.Component.SmartFeedTile.values)
   ...
   var view = function (model) {
      ...
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("header-row")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("logo-container")]),
                      _U.list([A2($Html.img,
                      _U.list([$Html$Attributes.$class("logo")
                              ,$Html$Attributes.src(model.logoUrl)]),
                      _U.list([]))]))
                      ,A2($Html.span,
              ...
              _U.list([]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("footer-row")]),
              _U.list([A2($Html.span,
                      _U.list([$Html$Attributes.$class("tile-title")]),
...
Elm.Component.StyleFilter.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      switch (_p0.ctor)
      {case "NoOp": return model;
         case "SelectStyle": var _p1 = _p0._0;
           var updatedStyles = A2($List.member,
           _p1,
           model.selectedStyles) ? model.selectedStyles : A2($List._op["::"],
           _p1,
           model.selectedStyles);
           return _U.update(model,{selectedStyles: updatedStyles});
         case "DeselectStyle": return _U.update(model,
           {selectedStyles: A2($List.filter,
           function (c) {
              return !_U.eq(c,_p0._0);
           },
           model.selectedStyles)});
         default: return _U.update(model,{selectedStyles: _U.list([])});}
   });
   var Clear = {ctor: "Clear"};
   var DeselectStyle = function (a) {
      return {ctor: "DeselectStyle",_0: a};
   };
   var SelectStyle = function (a) {
      return {ctor: "SelectStyle",_0: a};
   };
   var listItem = F3(function (address,selectedStyles,style) {
      var checked = A2($List.member,style,selectedStyles);
      var clickAction = checked ? DeselectStyle : SelectStyle;
      return A2($Html.li,
      _U.list([A2($Html$Events.onClick,address,clickAction(style))]),
      _U.list([A2($Common$CheckRow.view,style,checked)]));
   });
   var view = F2(function (address,model) {
      var featuredStylesCount = $List.length(model.featuredStyles);
      var selectedStylesCount = $List.length(model.selectedStyles);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("filter-panel product-filter")]),
      _U.list([_U.cmp(selectedStylesCount,0) > 0 ? A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Your current styles")]))
                      ,A2($Html.ul,
                      _U.list([$Html$Attributes.$class("blank products")]),
                      A2($List.map,
                      A2(listItem,address,model.selectedStyles),
                      model.selectedStyles))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn-small secondary")
                              ,A2($Html$Events.onClick,address,Clear)]),
              ...
              _U.list([]),
              _U.list([]))
              ,_U.cmp(featuredStylesCount,0) > 0 ? A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader")]),
                      _U.list([$Html.text("Styles featured in these products")]))
                      ,A2($Html.ul,
                      _U.list([$Html$Attributes.$class("blank")]),
                      A2($List.map,
                      A2(listItem,address,model.selectedStyles),
                      model.featuredStyles))
                      ,A2($Html.h6,
                      _U.list([$Html$Attributes.$class("subheader with-divider")]),
                      _U.list([$Html.text("Other styles")]))])) : A2($Html.div,
              _U.list([]),
              _U.list([]))
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("blank")]),
   ...
   var NoOp = {ctor: "NoOp"};
   var Model = F4(function (a,b,c,d) {
      return {featuredStyles: a
             ,selectedStyles: b
             ,otherStyles: c
             ,filteringComplete: d};
   });
   var dummyStyles = _U.list(["Traditional"
                             ,"Japanese/Zen"
                             ,"Transitional"
                             ,"Art"
                             ,"Nautical/Coastal"
                             ...
                             ,"Mid-century modern"
                             ,"Contemporary"]);
   var init = F2(function (selectedStyles,featuredStyles) {
      return {featuredStyles: featuredStyles
...
Elm.Component.SmartFeedTileDetail.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.SmartFeedTileDetail = _elm.Component.SmartFeedTileDetail || {};
   if (_elm.Component.SmartFeedTileDetail.values)
   return _elm.Component.SmartFeedTileDetail.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Common$Alias = Elm.Common.Alias.make(_elm),
   $Component$CategoryFilter = Elm.Component.CategoryFilter.make(_elm),
   ...
   var productView = F2(function (address,product) {
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("product-list-item")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("thumbnail-container")]),
              _U.list([A2($Html.img,
              _U.list([$Html$Attributes.$class("thumbnail")
                      ,$Html$Attributes.src(product.thumbnailUrl)]),
              _U.list([]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("title-container")]),
              _U.list([A2($Html.p,
                      _U.list([$Html$Attributes.$class("title")]),
                      _U.list([$Html.text(product.title)]))
                      ,A2($Html.p,
                      _U.list([$Html$Attributes.$class("price")]),
                      _U.list([$Html.text(A2($Basics._op["++"],
                      "$",
                      $Basics.toString(product.price)))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("actions-container")]),
              _U.list([A2($Html.i,
                      _U.list([$Html$Attributes.$class("fa fa-heart-o")]),
                      _U.list([]))
                      ,A2($Html.i,
                      _U.list([$Html$Attributes.$class("fa fa-cart-plus")]),
                      _U.list([]))
                      ,A2($Html.i,
   ...
   var ShowCategoryFilter = {ctor: "ShowCategoryFilter"};
   ...
   var CategoryFilterActions = function (a) {
      return {ctor: "CategoryFilterActions",_0: a};
   };
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         ...
         case "CategoryFilterActions": return _U.update(model,
           {productFilter: A2($Component$CategoryFilter.update,
           _p0._0,
           model.productFilter)});
         ...
         case "ShowCategoryFilter": return _U.update(model,
           {visibleFilter: Category});
         case "ShowStyleFilter": return _U.update(model,
           {visibleFilter: Style});
         default:
         var updatedFilter = {colour: model.colourFilter.selectedPalette
           ...
           {filter: updatedFilter,filteringComplete: true});}
   });
   var None = {ctor: "None"};
   var init = F2(function (tile,filter) {
      return {products: tile.products
             ...
             filter.colour,
             tile.palette)
             ,materialFilter: A2($Component$MaterialFilter.init,
             filter.material,
             tile.materials)
             ,productFilter: A2($Component$CategoryFilter.init,
             filter.category,
             A2($List.map,
             function (_) {
                return _.category;
             ...
             tile.products))
             ,styleFilter: A2($Component$StyleFilter.init,
             filter.style,
             tile.styles)
             ,filteringComplete: false};
   });
   var filterView = F2(function (address,model) {
      var currentFilter = function () {
         ...
         {case "None": return A2($Html.div,_U.list([]),_U.list([]));
            ...
            case "Material": return A2($Component$MaterialFilter.view,
              ...
              model.materialFilter);
            case "Category": return A2($Component$CategoryFilter.view,
              A2($Signal.forwardTo,address,CategoryFilterActions),
              model.productFilter);
      ...
      _U.list([A2($Html.span,
              ...
              _U.list([$Html.text("Show me more of this...")]))
              ,A2($Html.div,
              ...
              _U.list([A2($Html.button,
                      ...
                      _U.list([$Html.text("Material")]))
                      ,A2($Html.button,
                      _U.list([A2($Html$Events.onClick,address,ShowCategoryFilter)]),
                      _U.list([$Html.text("Category")]))
                      ,A2($Html.button,
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.ul,
              _U.list([$Html$Attributes.$class("product-list")]),
...
Elm.Component.SmartFeed.make = function (_elm) {
   "use strict";
   _elm.Component = _elm.Component || {};
   _elm.Component.SmartFeed = _elm.Component.SmartFeed || {};
   if (_elm.Component.SmartFeed.values)
   ...
   var dummyProductsTwo = _U.list([{title: "Product 4"
                                  ...
                                  ,{title: "Mariner Floor Lamp"
                                   ...
                                   ,url: "/products/7"
                                   ,category: "Lamps"}]);
   var dummyProductsOne = _U.list([{title: "Dahlia sofa"
...
Elm.Component.MobileSimulator.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([model.isDeviceMobile ? A2($Component$SmartFeed.view,
      A2($Signal.forwardTo,address,SmartFeed),
      model.smartFeed) : A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h4,
              _U.list([]),
   ...
   var init = function (isDeviceMobile) {
      return {smartFeed: $Component$SmartFeed.init
             ,isDeviceMobile: isDeviceMobile};
   };
   var model = function (isDeviceMobile) {
   ...
   var Model = F2(function (a,b) {
      return {smartFeed: a,isDeviceMobile: b};
   });
...
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Component$MobileSimulator = Elm.Component.MobileSimulator.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var _op = {};
   var isDeviceMobile = Elm.Native.Port.make(_elm).inbound("isDeviceMobile",
   "Bool",
   function (v) {
      return typeof v === "boolean" ? v : _U.badPort("a boolean (true or false)",
      v);
   });
   var main = $StartApp$Simple.start({model: $Component$MobileSimulator.init(isDeviceMobile)
                                     ,update: $Component$MobileSimulator.update
                                     ,view: $Component$MobileSimulator.view});
